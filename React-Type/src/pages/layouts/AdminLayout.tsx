        ...
        <div className='bgc-dashboard max-w-7xl	m-auto'>
            ...
            <div className="grid grid-cols-2 gap-5">
                    <div className='max-w-5xl'>
                        ...
                        <h1 className='mt-4 my-5 mx-auto pb-5 border-b border-red-400 dark:border-cyan-900 w-48 text-center font-medium text-5xl dark:text-white'>NqDyy</h1>
                                <ul className="space-y-2">
                                    <li>
                                        <a href="/admin/dashboard" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
